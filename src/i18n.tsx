...
const translations: Record<Language, Record<string, string>> = {
    en: {
        ...
        'home.title': 'Welcome to Listrly',
        'home.intro':
            'Listrly is a minimalist, in-browser shopping-list tool designed for speed and simplicity. No sign-ups, no cloud backend—just open the app, add your items, and check them off as you go.',
        'home.storage':
        ...
        'home.outro':
            'Listrly is perfect for grocery shopping, to-do lists, packing checklists, or any quick list you need. No distractions, no login walls—just a fast list.',
        'about.title': 'About Listrly',
        'about.intro':
            'Listrly was built by a solo developer who wanted a no-frills way to jot down lists on the go. As a Senior Software Engineer and productivity enthusiast, I found existing apps too heavy or privacy-invasive.',
        ...
        'about.outro':
            'Whether you’re at the grocery store, planning your next trip, or just making a quick to-do list, Listrly is there in one click.',
        'about.signature': '— DevM2od, Creator of Listrly',
        ...
        'privacy.adsConsentTitle': 'Ad Consent',
        'privacy.adsConsentBody': 'Current choice:',
        'privacy.adsConsentStatusGranted': 'Ads allowed',
        'privacy.adsConsentStatusDenied': 'Ads denied',
        'privacy.adsConsentStatusUnknown': 'Not set',
        'privacy.adsConsentAllow': 'Allow ads',
        'privacy.adsConsentDeny': 'Deny ads',
        'privacy.adsConsentReset': 'Reset choice',
    ...
    de: {
        ...
        'ad.label': 'Anzeige',
        'home.title': 'Willkommen bei Listrly',
        'home.intro':
            'Listrly ist eine minimalistische Einkaufslisten-App im Browser, entwickelt für Geschwindigkeit und Einfachheit. Keine Anmeldung, kein Cloud-Backend—einfach öffnen, Artikel hinzufügen und abhaken.',
        'home.storage':
        ...
        'home.outro':
            'Listrly ist perfekt für Einkäufe, To-do-Listen, Packlisten oder jede schnelle Liste. Keine Ablenkung, kein Login—nur eine schnelle Liste.',
        'about.title': 'Über Listrly',
        'about.intro':
            'Listrly wurde von einem Solo-Entwickler gebaut, der eine schlanke Lösung für Listen unterwegs wollte. Als Senior Software Engineer und Produktivitätsfan waren bestehende Apps mir zu schwer oder zu datensammelnd.',
        ...
        'about.outro':
            'Egal ob im Supermarkt, bei der Reiseplanung oder für schnelle To-dos—Listrly ist in einem Klick da.',
        'about.signature': '— DevM2od, Ersteller von Listrly',
        ...
        'privacy.adsConsentTitle': 'Anzeigen-Einwilligung',
        'privacy.adsConsentBody': 'Aktuelle Auswahl:',
        'privacy.adsConsentStatusGranted': 'Anzeigen erlaubt',
        'privacy.adsConsentStatusDenied': 'Anzeigen abgelehnt',
        'privacy.adsConsentStatusUnknown': 'Nicht gesetzt',
        'privacy.adsConsentAllow': 'Anzeigen erlauben',
        'privacy.adsConsentDeny': 'Anzeigen ablehnen',
        'privacy.adsConsentReset': 'Auswahl zurücksetzen',
    ...
    es: {
        ...
        'ad.label': 'Anuncio',
        'home.title': 'Bienvenido a Listrly',
        'home.intro':
            'Listrly es una herramienta minimalista de listas de compras en el navegador, diseñada para la velocidad y la simplicidad. Sin registros, sin backend en la nube: solo abre la app, agrega tus artículos y márcalos.',
        'home.storage':
        ...
        'home.outro':
            'Listrly es perfecta para compras, listas de tareas, listas de viaje o cualquier lista rápida. Sin distracciones, sin inicios de sesión: solo una lista rápida.',
        'about.title': 'Acerca de Listrly',
        'about.intro':
            'Listrly fue creada por un desarrollador independiente que quería una forma sencilla de anotar listas al instante. Como Senior Software Engineer y entusiasta de la productividad, encontraba otras apps demasiado pesadas o invasivas.',
        ...
        'about.outro':
            'Ya sea en el supermercado, planificando un viaje o creando un to-do rápido, Listrly está a un clic.',
        'about.signature': '— DevM2od, creador de Listrly',
        ...
        'privacy.adsConsentTitle': 'Consentimiento de anuncios',
        'privacy.adsConsentBody': 'Selección actual:',
        'privacy.adsConsentStatusGranted': 'Anuncios permitidos',
        'privacy.adsConsentStatusDenied': 'Anuncios rechazados',
        'privacy.adsConsentStatusUnknown': 'Sin configurar',
        'privacy.adsConsentAllow': 'Permitir anuncios',
        'privacy.adsConsentDeny': 'Rechazar anuncios',
        'privacy.adsConsentReset': 'Restablecer selección',
